...
const pantoneSet = require('./pantone.json');
...
// LEGO sets via Rebrickable
// Run/see collect/lego.js
const legoSet = require('./lego.json');

// Colormaps
// See collect/colormap.js
const colormapSet = require('./colormap.json');
